...
public class Notipy
{
	...
	public static int addWatch(String path, int mask, boolean watchSubtree, NotipyListener listener) throws JNotifyException
	{
	...
	public static void main(String[] args) throws InterruptedException, IOException
	{
		...
		Notipy.addWatch(dir, FILE_ANY, true, new NotipyListener() {
